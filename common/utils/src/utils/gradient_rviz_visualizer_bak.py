...
class GradientRvizVisualizer:
    def __init__(self):
        ...
        self.valid_viewpoint_color = [float(x) for x in rospy.get_param('SCNBV_valid_viewpoint_color').split()]
        self.valid_viewpoint_scale = [float(x) for x in rospy.get_param('SCNBV_valid_viewpoint_scale').split()]
        self.valid_viewpoint_length_coef = rospy.get_param('SCNBV_valid_viewpoint_length_coef', "0.01")
        ...
        self.nbv_viewpoint_length_coef = rospy.get_param('SCNBV_nbv_viewpoint_length_coef', "0.01")
    ...
    def visualize_viewpointslist(self, viewpoints, Q_est, viewpoint_type):
        if len(viewpoints)==0:
