...
def move_to_predefined_pose():
    ...
    while True:
        ...
        try:
            ...
            # ################
            # Define orientation constraints to keep the end effector horizontal
            if False:
                ...
                # orientation_constraint.absolute_x_axis_tolerance = 1.01
                # orientation_constraint.absolute_y_axis_tolerance = 1.01
                # orientation_constraint.absolute_z_axis_tolerance = 3.14  # Allow free rotation around z-axis
                # orientation_constraint.absolute_z_axis_tolerance = 0.01  # Allow free rotation around z-axis
