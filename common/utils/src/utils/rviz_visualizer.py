...
class RvizVisualizer:
    def __init__(self):
        ...
        self.view_samples_pub = rospy.Publisher("view_samples", MarkerArray, queue_size=1)
    ...
    def visualize_voxels(self, points: np.array, semantics: np.array, class_ids: np.array) -> None:
        """
        ...
        color_fruit = struct.unpack("I", struct.pack("BBBB", 0, 0, 255, 255))[0]
        color_contour = struct.unpack("I", struct.pack("BBBB", 255, 0, 255, 255))[0]
        ...
        for i in range(points.shape[0]):
            ...
            if class_ids[i] == 1:
                points_arr["rgb"][i] = color_contour
